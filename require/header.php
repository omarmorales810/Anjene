          ...
          <ul class="bag-view-container">
            <li class="bag-view-item">
              <span class="view-content-svg-container">
                <svg class="view-content-bag" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                  <g>
