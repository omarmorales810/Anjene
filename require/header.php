    ...
    <nav class="nav">
      <div class="nav-container">
        ...
        <ul class="nav-categories">
          <li class="nav-item">
            <a href="" class="nav-link">Electronic Devices</a>
          </li>
          <li class="nav-item">
            <a href="" class="nav-link">Health & Beauty</a>
          </li>
          <li class="nav-item">
            <a href="" class="nav-link">Babies & Toys</a>
          </li>
          <li class="nav-item">
            <a href="" class="nav-link">Groceries & Pets</a>
          </li>
          <li class="nav-item">
            <a href="" class="nav-link">Home & Living</a>
          </li>
          <li class="nav-item">
            <a href="" class="nav-link">Fashion Accesories</a>
          </li>
        </ul>
        <div class="nav-profile">
          <div class="search">
            <svg class="nav-svg" xmlns="http://www.w3.org/2000/svg" width="15" height="88" viewBox="0 0 15 88"><rect width="15" height="44" fill="none"/><path d="M13.98,27.343l-3.5-3.5a5.436,5.436,0,1,0-.778.777l3.5,3.5a.55.55,0,1,0,.778-.778ZM1.959,20.418a4.319,4.319,0,1,1,4.319,4.32A4.323,4.323,0,0,1,1.959,20.418Z" fill="#000"/></svg>
          </div>
          <div class="bag">
            <svg class="nav-svg" xmlns="http://www.w3.org/2000/svg" style="cursor: pointer;" height="44" viewBox="0 0 13 44" width="13"><g fill="none" fill-rule="evenodd"><path d="m0 44h13v-44h-13z"/><path d="m12 25.9c0 .6-.5 1.1-1.1 1.1h-8.8c-.6 0-1.1-.5-1.1-1.1v-7.9c0-.5.5-1 1.1-1h8.9c.6 0 1.1.5 1.1 1.1v7.8zm-5.5-11.9c1.2 0 2.1.9 2.3 2h-4.6c.2-1.1 1.1-2 2.3-2zm4.4 2h-1.1c-.2-1.7-1.6-3-3.3-3s-3.1 1.3-3.3 3h-1.1c-1.2 0-2.1.9-2.1 2.1v7.9c0 1.1.9 2 2.1 2h8.9c1.1 0 2.1-.9 2.1-2.1v-7.9c-.1-1.1-1-2-2.2-2z" fill="#000"/></g></svg>
          </div>
        </div>
      </div>
    </nav>
